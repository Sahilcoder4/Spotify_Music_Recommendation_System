...
Client_Secret = 'd49008702f144f2f9fad56dc81ee4904'
...
def get_trending_playlist_data(playlist_id, access_token):
    ...
    for track_info in playlist_tracks['items']:
        ...
        audio_features = sp.audio_features(track_id)[0] if track_id != 'Not avaiable' else None
...
playlist_id = '0pnRd88peqxw16VL45GD3j'
...
def calculate_weighted_popularity(release_date):
    ...
    # Calculate the weighted popularity score based on time span(e.g., more recent release have higher weight)
...
def hybrid_recommendations(input_song_name, num_recommendations=5, alpha=0.5):
    ...
    # Create a DataFrame to append to content-based recommendations 
